...
export function AuthLayout() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-brand-50 to-slate-100">
      <div className="w-full flex min-h-screen flex-col lg:flex-row">
        <aside className="w-1/2 hidden overflow-hidden bg-brand-900 px-16 py-12 text-white lg:flex lg:w-1/2 lg:flex-col lg:justify-between">
          <div>
            ...
            <h1 className="mt-12 text-4xl font-bold leading-tight">
              Quản lý cửa hàng
              <br />
              <span className="text-brand-100">đơn giản & hiệu quả</span>
            </h1>
            <p className="mt-4 max-w-md text-brand-100/90 leading-relaxed">
        ...
        <main className="w-1/2 flex items-center justify-center px-4 py-10 sm:px-8">
          <div className="w-full max-w-md">
            <div className="mb-8 text-center lg:hidden">
              <Link to="/" className="inline-flex items-center gap-2 text-lg font-bold text-brand-900">
